...
RUN pip3 install pandas shapely fiona==1.8.20

COPY . /opt/task/

RUN pip3 install -r /opt/task/requirements.txt /opt/task/

ENTRYPOINT ["python3", "/opt/task/crop_raster_from_mp_task.py"]
